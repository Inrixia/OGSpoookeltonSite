...
<head>
    ...
    <title>Ulearn Physics - Mechanics</title>
</head>
<body>
...
<div class="page">
  ...
  <div class="content">
    <div class="content_inner">
		<header class="header"><h1>Ulearn - Mechanics</h1></header>
		<div class="wrapper">
			<div class="videoWrapper">
			    <!-- Copy & Pasted from YouTube -->
			    <iframe width="560" height="349" src="https://www.youtube.com/embed/VbCJYvssNtE" allowfullscreen></iframe>
			</div>
			<div class="main">
				<!--Quizz-->
				<div id='container'>
...
<!--Links for js-->
    <script src="js/quizz2.js" type="text/javascript"></script>
