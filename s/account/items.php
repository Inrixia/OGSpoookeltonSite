    ...
    <div class="content">
      <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <?php
            $connection = new mysqli('localhost', 'root', 'Sp00ked', 'frosty');
            $sql = "SELECT * FROM products"; // Get every product from the products table
            if (!$result = $connection->query($sql)) {}
            while ($row = $result->fetch_array()) { // For each product in the products table display its details
              ...
              if ($stock > 0) { 
                ...
                ";
              } else { // If the stock is 0 then grey the minus button
